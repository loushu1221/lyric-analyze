# -*- coding: utf-8 -*-
"""
Created on Sun Jun 30 16:00:22 2019
...
all_words=[]
outstr = ''
for filename in os.listdir('6452'):
    with open('6452/'+filename) as f:
        lyrics=f.read()
...
color_mask=imread('cloud.jpg') #背景图
cloud=WordCloud(
...
world_cloud.to_file('jielun.jpg')
