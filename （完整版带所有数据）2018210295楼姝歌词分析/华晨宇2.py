# -*- coding: utf-8 -*-
"""
Created on Sun Jun 30 16:19:57 2019
...
all_words=[]
outstr = ''
for filename in os.listdir('861777'):
    with open('861777/'+filename) as f:
        lyrics=f.read()
...
color_mask=imread('pika.jpg') #背景图
cloud=WordCloud(
...
world_cloud.to_file('huachenyu.jpg')
