# -*- coding: utf-8 -*-
"""
Created on Sun Jun 30 15:52:55 2019
...
all_words=[]
outstr = ''
for filename in os.listdir('11127'):
    with open('11127/'+filename) as f:
        lyrics=f.read()
...
world_cloud.to_file('beyond.jpg')
